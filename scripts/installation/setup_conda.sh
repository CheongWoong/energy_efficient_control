# reference: https://github.com/kmeng01/rome
#!/bin/bash
...
# Default RECIPE 'energy_efficient_control' can be overridden by 'RECIPE' environment variable
RECIPE=${RECIPE:-energy_efficient_control}
# Default ENV_NAME 'energy_efficient_control' can be overridden by 'ENV_NAME'
